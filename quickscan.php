												...
												while ($row = $result->fetch_assoc()) {
													...
													echo '
														<div class="row align-items-center question ' . $questionClass . '" data-question="q' . $questionId . '">
															...
															<div class="col-6">
																<div class="row">
																	<div class="col text-center"><input type="radio" id="Pillar1_q' . $questionId . '" name="Pillar1_q' . $questionId . '_'.$questionWeight.'" 	value="1" required></div>
												...
												while ($row = $result->fetch_assoc()) {
													...
													echo '
														<div class="row align-items-center question ' . $questionClass . '" data-question="q' . $questionId . '">
															...
															<div class="col-6">
																<div class="row">
																	<div class="col text-center"><input type="radio" id="Pillar2_q' . $questionId . '" name="Pillar2_q' . $questionId . '_'.$questionWeight.'" 	value="1" required></div>
												...
												while ($row = $result->fetch_assoc()) {
													...
													echo '
														<div class="row align-items-center question ' . $questionClass . '" data-question="q' . $questionId . '">
															...
															<div class="col-6">
																<div class="row">
																	<div class="col text-center"><input type="radio" id="Pillar3_q' . $questionId . '" name="Pillar3_q' . $questionId . '_'.$questionWeight.'" 	value="1" required></div>
												...
												while ($row = $result->fetch_assoc()) {
													...
													echo '
														<div class="row align-items-center question ' . $questionClass . '" data-question="q' . $questionId . '">
															...
															<div class="col-6">
																<div class="row">
																	<div class="col text-center"><input type="radio" id="Pillar4_q' . $questionId . '" name="Pillar4_q' . $questionId . '_'.$questionWeight.'" 	value="1" required></div>
												...
												while ($row = $result->fetch_assoc()) {
													...
													echo '
														<div class="row align-items-center question ' . $questionClass . '" data-question="q' . $questionId . '">
															...
															<div class="col-6">
																<div class="row">
																	<div class="col text-center"><input type="radio" id="Pillar5_q' . $questionId . '" name="Pillar5_q' . $questionId . '_'.$questionWeight.'" 	value="1" required></div>
												...
												while ($row = $result->fetch_assoc()) {
													...
													echo '
														<div class="row align-items-center question ' . $questionClass . '" data-question="q' . $questionId . '">
															...
															<div class="col-6">
																<div class="row">
																	<div class="col text-center"><input type="radio" id="Pillar6_q' . $questionId . '" name="Pillar6_q' . $questionId . '_'.$questionWeight.'" 	value="1" required></div>
												...
												while ($row = $result->fetch_assoc()) {
													...
													echo '
														<div class="row align-items-center question ' . $questionClass . '" data-question="q' . $questionId . '">
															...
															<div class="col-6">
																<div class="row">
																	<div class="col text-center"><input type="radio" id="Pillar7_q' . $questionId . '" name="Pillar7_q' . $questionId . '_'.$questionWeight.'" 	value="1" required></div>
